...
class ROS_interface:
    def __init__(self):
        ...
        self.gimbal_pub = rospy.Publisher('/joint_command', JointState, queue_size=10)
    ...
    def set_gimble_theta(self, target_theta0, target_theta1, target_theta2):
        ...
        gimbal_cmd.position = [(45/180)*math.pi, (45/180)*math.pi, (45/180)*math.pi]
    ...
    def calculate_target_orientation(self):#TODO
        """
